...
def create_optparser():
    ...
    g.add_option("--spec", action="store", default=qt_macx_spec, metavar="SPEC",
            dest="qt_macx_spec", help="qmake specification [default: macx-g++]")
...
def main():
    ...
    # Store spec
    qt_macx_spec = opts.qt_macx_spec
